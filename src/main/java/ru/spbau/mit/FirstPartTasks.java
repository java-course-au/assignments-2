...
public final class FirstPartTasks {
    ...
    public static final int FAVORITE_RATING = 95;
    ...
    public static List<Album> sortedFavorites(Stream<Album> s) {
        return s
                .filter(album -> album.getTracks().stream().anyMatch(track -> track.getRating() > FAVORITE_RATING))
                .sorted(Comparator.comparing(Album::getName, Comparator.<String>naturalOrder()))
                .collect(Collectors.toList());
    }
