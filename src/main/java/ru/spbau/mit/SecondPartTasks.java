...
public final class SecondPartTasks {
    ...
    private static final Random RANDOM = new Random(26012016);
    ...
    public static String findPrinter(Map<String, List<String>> compositions) {
        return compositions
                ...
                .collect(
                        Collectors.toMap(
                                Map.Entry::getKey,
                                stringListEntry1 -> stringListEntry1
                                        .getValue().stream()
                                        .collect(Collectors.<String>summingInt(String::length))
                        )
                )
                .entrySet().stream()
                .max(
